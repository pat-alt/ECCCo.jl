...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{../camera-ready/figures/mnist_motivation.png}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.75\linewidth]{../camera-ready/figures/poc_gradient_fields.png}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\linewidth]{../camera-ready/figures/mnist_benchmark.png}
