...
\begin{question}[Faithfulness]\label{rq:feasibility}
  Are ECCCos more faithful to the black-box model than counterfactuals produced by benchmark generators?
\end{question}
