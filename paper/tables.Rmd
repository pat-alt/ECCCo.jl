...
for (name in unique(tab$dataname)) {
  ...
  cap <- sprintf(
    "All results for %s dataset: sample averages +/- one standard deviation over all counterfactuals. Best outcomes are highlighted in bold. Asterisks indicate that the given value is more than one (*) or two (**) standard deviations away from the baseline (Wachter). \\label{tab:results-%s} \\newline",
    name,
    data_indicator
  )
  kbl(
...
for (name in unique(tab_valid$dataname)) {
  ...
  cap <- sprintf(
    "All results for %s dataset: sample averages +/- one standard deviation over all valid counterfactuals. Best outcomes are highlighted in bold. Asterisks indicate that the given value is more than one (*) or two (**) standard deviations away from the baseline (Wachter). \\label{tab:results-%s} \\newline",
    name,
    data_indicator
  )
  kbl(
